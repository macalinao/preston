 ...
 * @param {Function} modifier - The modifier(req, value) function. Should return the new value.
 ...
 * });
 *
 * @param {Function} transformer - The transformer(req, doc).
 * @returns {Model} The instance of this model
 */
...
Model.prototype.applyTransforms = function(req, doc) {
  ...
  _.forEach(this.transformers, function(tf) {
    tf(req, jsoned);
  });
  return jsoned;
};
