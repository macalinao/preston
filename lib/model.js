 ...
 */
Model.prototype.applyModifiers = function(req) {
  // Apply modifiers
  // The try/catch allows us to throw errors in modifiers.
  try {
    _.forEach(this.modifiers, function(mod) {
...
Model.prototype.transformPopulate = function(field, transformer) {
  ...
  if (transformer.length === 2) {
    ...
    this.transform(function(req, doc, next) {
