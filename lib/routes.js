...
exports.create = function(thiz, Mod) {
  return function(req, res) {
...
exports.get = function(thiz, Mod) {
  return function(req, res) {
    if (Mod !== thiz.model) {
      return res.error(500, 'Subdocs unimplemented');
    }
    res.json(thiz.applyTransforms(req, req.doc));
  };
};

exports.update = function(thiz, Mod) {
  return function(req, res) {
    if (Mod !== thiz.model) {
      return res.error(500, 'Subdocs unimplemented');
    }
...
exports.delete = function(thiz, Mod) {
  return function(req, res) {
    if (Mod !== thiz.model) {
      return res.error(500, 'Subdocs unimplemented');
    }
