  ...
  return function(req, res, next) {
    ...
    model.applyModifiers(req, function(err, request) {
      ...
      query.exec(function(err, docs) {
        ...
        model.applyTransforms(req, docs, function(err, jsoned) {
          if (model.parent) {
            model.parent.customResponse(jsoned, function(err, jsoned) {
              res.json(jsoned);
            });
          } else {
            model.customResponse(jsoned, function(err, jsoned) {
              res.json(jsoned);
            });
          }
